...
<div class="Booking">
    ...
    <div class="row">
        <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-header"><strong>Register Stationery</strong></div>
                    <div class="card-body card-block">
                        <div class="text-danger">{{ $exist }}</div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="code" class=" form-control-label">Code</label>
                                    <input type="text" id="code" name="code" placeholder="Enter stationery code" class="form-control">
                                    @error('code')
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="quantity" name="quantity" placeholder="Enter stationery quantiry" class="form-control">
                                    @error('quantity')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stock" name="stock" placeholder="Enter total stock remain" class="form-control">
                                    @error('stock')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
