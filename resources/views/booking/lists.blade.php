...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- <link rel="stylesheet" href="{{ asset('/assets/npm/themify-icons@0.1.2/css/themify-icons.css') }}"> --}}
        {{-- <link rel="stylesheet" href="{{ asset('/assets/npm/pixeden-stroke-7-icon@1.2.3/pe-icon-7-stroke/dist/pe-icon-7-stroke.min.css') }}"> --}}
        {{-- <link rel="stylesheet" href="{{ asset('/assets/npm/flag-icon-css/3.2.0/css/flag-icon.min.css') }}"> --}}
                            ...
                            <div class="card-body">
                                <div class="row form-group justify-content-center">
                                     <div class="col-12 col-xl-2 py-3">
                                        ...
                                        <select name="time_in" id="select" class="form-control">
                                    ...
                                    <div class="col-12 col-xl-3 py-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" data-field="date" id="date-booking">
                                        </div>
                                    </div>
                                    <div class="col-6 col-xl-2 col-sm-6 py-3">
                                     ...
                                     <div class="col-6 col-xl-2 col-sm-6 py-3">
                                        ...
                                        <select name="time_ut" id="select" class="form-control">
                                             @foreach (Config::get('times') as $index => $value)
                                                <option value="{{ $value }}">{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-xl-1 py-3">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm form-control"><i class="fa-solid fa-magnifying-glass"></i>&nbsp; </button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Booking Lists </h4>
                                </div>
                                <div class="card-body--">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span class="count">Voeun Rotha</span></td>
                                                    <td><span class="count">ICT Dept</span></td>
                                                    <td>
